...
// Type guards for segments
function isActivitySegment(segment: Segment): segment is Segment & { type: 'ACTIVITY' } {
  return segment.type === 'ACTIVITY';
}
function isFlightSegment(segment: Segment): segment is Segment & { type: 'FLIGHT' } {
  return segment.type === 'FLIGHT';
}
function isHotelSegment(segment: Segment): segment is Segment & { type: 'HOTEL' } {
  return segment.type === 'HOTEL';
}
function isTransferSegment(segment: Segment): segment is Segment & { type: 'TRANSFER' } {
